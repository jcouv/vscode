...
import './media/quickWatch.css';
import { QUICK_WATCH_CONTEXT_MENU, QuickWatchEditor } from './quickWatchView.js';
...
registerDebugCommandPaletteItem('debug.quickWatch', nls.localize2('quickWatchCommandPalette', "Quick Watch"));
...
registerDebugViewMenuItem(QUICK_WATCH_CONTEXT_MENU, COPY_VALUE_ID, COPY_VALUE_LABEL, 40, CONTEXT_WATCH_ITEM_TYPE.isEqualTo('expression'), CONTEXT_IN_DEBUG_MODE, '3_modification');
registerDebugViewMenuItem(QUICK_WATCH_CONTEXT_MENU, ADD_TO_WATCH_ID, ADD_TO_WATCH_LABEL, 100, CONTEXT_WATCH_ITEM_TYPE.isEqualTo('expression'), undefined, 'z_commands');
registerDebugViewMenuItem(QUICK_WATCH_CONTEXT_MENU, VIEW_MEMORY_ID, nls.localize('viewMemory', "View Binary Data"), 10, CONTEXT_CAN_VIEW_MEMORY, undefined, 'inline', icons.debugInspectMemory);
registerDebugViewMenuItem(QUICK_WATCH_CONTEXT_MENU, BREAK_WHEN_VALUE_IS_READ_ID, nls.localize('breakWhenValueIsRead', "Break on Value Read"), 200, CONTEXT_BREAK_WHEN_VALUE_IS_READ_SUPPORTED, undefined, 'z_commands');
registerDebugViewMenuItem(QUICK_WATCH_CONTEXT_MENU, BREAK_WHEN_VALUE_CHANGES_ID, nls.localize('breakWhenValueChanges', "Break on Value Change"), 210, CONTEXT_BREAK_WHEN_VALUE_CHANGES_SUPPORTED, undefined, 'z_commands');
registerDebugViewMenuItem(QUICK_WATCH_CONTEXT_MENU, BREAK_WHEN_VALUE_IS_ACCESSED_ID, nls.localize('breakWhenValueIsAccessed', "Break on Value Access"), 220, CONTEXT_BREAK_WHEN_VALUE_IS_ACCESSED_SUPPORTED, undefined, 'z_commands');
...
Registry.as<IEditorPaneRegistry>(EditorExtensions.EditorPane).registerEditorPane(
	EditorPaneDescriptor.create(QuickWatchEditor, QUICK_WATCH_VIEW_ID, nls.localize('quickWatchEditor', "Quick Watch")),
	[new SyncDescriptor(QuickWatchEditorInput)]
);
