...
export const CONTEXT_IN_WATCH_EXPRESSION_INPUT = new RawContextKey<boolean>('inWatchExpressionInput', false, { type: 'boolean', description: nls.localize('inWatchExpressionInput', "True when focus is in the watch expression input, false otherwise.") });
